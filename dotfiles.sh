...
provision_ubuntu () {
    ...
    sudo apt-get update
    sudo apt-get install -y python2 libpython2-dev python3 python3-venv tree git mercurial jq tmux htop make build-essential autojump vim curl strace sysstat tcpdump dnsutils
